...
function DisputeDiagram() {
  return (
    <svg viewBox="0 0 420 240" className="w-full">
      ...
      <text x="210" y="52" textAnchor="middle" fontSize="12" fill="var(--color-foreground)" fontFamily="Plus Jakarta Sans" fontWeight="600">ZUNO Escrow (frozen)</text>

      <rect x="20" y="120" width="120" height="42" rx="12" fill="none" stroke="var(--color-muted-foreground)" strokeWidth="1.2" />
      <text x="80" y="146" textAnchor="middle" fontSize="11" fill="var(--color-foreground)" fontFamily="Plus Jakarta Sans">Buyer evidence</text>
      <rect x="280" y="120" width="120" height="42" rx="12" fill="none" stroke="var(--color-muted-foreground)" strokeWidth="1.2" />
      <text x="340" y="146" textAnchor="middle" fontSize="11" fill="var(--color-foreground)" fontFamily="Plus Jakarta Sans">Seller evidence</text>

      <rect x="150" y="190" width="120" height="42" rx="12" fill="var(--color-primary)" opacity="0.9" />
      <text x="210" y="216" textAnchor="middle" fontSize="11" fill="var(--color-primary-foreground)" fontFamily="Plus Jakarta Sans" fontWeight="600">Case ruling</text>
