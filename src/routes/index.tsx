          ...
          {submitted ? (
            ...
            >
              <input
                ...
                placeholder="Email"
                className="h-16 w-full rounded-full bg-white/25 px-6 text-lg font-medium text-white placeholder:text-white/80 outline-none focus:bg-white/35 sm:h-12 sm:flex-1 sm:bg-white/15 sm:text-[15px] sm:font-normal"
              />
              <button
                type="submit"
